  ...
  return (
    <>
      <div className="container-fluid">
        ...
        {/* <!-- section --> */}
        <div className="row">
          <div className="col-12 px-5 pt-4"></div>
          {/* <!-- food item --> */}
                ...
                <div>
                  <div className="ms-1">
                    <input
                      ...
                      onChange={setFilterForPage}
                    />
                    <label htmlFor="first" className="form-check-label ms-1">
                      less then 500
                    </label>
                  </div>
                  <div className="ms-1">
                    <input
                      ...
                      onChange={setFilterForPage}
                    />
                    <label htmlFor="second" className="form-check-label ms-1">
                      500 to 1000
                    </label>
                  </div>
                  <div className="ms-1">
                    <input
                      ...
                      onChange={setFilterForPage}
                    />
                    <label htmlFor="third" className="form-check-label ms-1">
                      1000 to 1500
                    </label>
                  </div>
                  <div className="ms-1">
                    <input
                      ...
                      onChange={setFilterForPage}
                    />
                    <label htmlFor="fourth" className="form-check-label ms-1">
                      1500 to 2000
                    </label>
                  </div>
                  <div className="ms-1">
                    <input
                      ...
                      onChange={setFilterForPage}
                    />
                    <label htmlFor="sixth" className="form-check-label ms-1">
                      2000+
                    </label>
                  </div>
                </div>
